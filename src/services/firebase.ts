...
export async function getFirebaseApp(): Promise<FirebaseApp | null> {
  ...
  try {
    ...
    _app = apps[0] ?? initializeApp({
      apiKey: process.env.EXPO_PUBLIC_FIREBASE_API_KEY || 'AIzaSyCDyQwKJmdS_nLhoHhk0t4h-MOtbOEEHzA',
      authDomain: process.env.EXPO_PUBLIC_FIREBASE_AUTH_DOMAIN || 'crisissenseai.firebaseapp.com',
      projectId: process.env.EXPO_PUBLIC_FIREBASE_PROJECT_ID || 'crisissenseai',
      storageBucket: process.env.EXPO_PUBLIC_FIREBASE_STORAGE_BUCKET || 'crisissenseai.firebasestorage.app',
      messagingSenderId: process.env.EXPO_PUBLIC_FIREBASE_MESSAGING_SENDER_ID || '10031778201',
      appId: process.env.EXPO_PUBLIC_FIREBASE_APP_ID || '1:10031778201:android:cb5fcdabc5168002076b08',
    });
    return _app;
  } catch (e) {
